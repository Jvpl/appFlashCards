...
const styles = StyleSheet.create({
  ...
  card: { width: screenWidth * 0.9, height: 460, backgroundColor: theme.backgroundTertiary, borderRadius: 20, justifyContent: 'space-between', alignItems: 'center', padding: 0, backfaceVisibility: 'hidden', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', overflow: 'hidden' },
