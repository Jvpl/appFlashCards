...
import { View, Text, TouchableOpacity, StyleSheet, Alert, KeyboardAvoidingView, Platform, ScrollView, ActivityIndicator, Modal, TouchableWithoutFeedback, TextInput, Button } from 'react-native';
...
export const EditFlashcardScreen = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.baseContainer}>
      ...
      >
          <ScrollView 
            ...
            contentContainerStyle={[
                ...
                { 
                    paddingBottom: keyboardHeight > 0 ? Math.max(20, keyboardHeight - 50) : (isMathToolbarVisible ? 240 : 20),
                    flexGrow: 1 
                }
            ]}
                    ...
                    <TouchableWithoutFeedback onPress={handleDismissKeyboard}>
                         <View style={[styles.bottomControlsContainer, { width: '100%', paddingTop: 26, paddingBottom: 20 }]}>
                            ...
                            <View style={styles.saveButtonContainer}>
                                <Button title="Salvar Alterações" onPress={(e) => { e.stopPropagation(); handleSave(); }} color="#4FD1C5" />
                            </View> 
                        </View>
                    </TouchableWithoutFeedback>
               </View>
      ...
      {isMathToolbarVisible && <MathToolbar onInsert={handleInsertMath} onClose={() => setMathToolbarVisible(false)} />}
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
            <View style={styles.modalOverlay}>
                <View style={styles.modalContent}>
                    ...
                    <TouchableOpacity style={[styles.modalButton, { marginTop: 20 }]} onPress={() => {
                    ...
                    <TouchableOpacity style={[styles.modalButton, { marginTop: 10, backgroundColor: '#A0AEC0' }]} onPress={() => setEditModalVisible(false)}>
